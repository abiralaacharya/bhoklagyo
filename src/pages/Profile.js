...
function Profile() {
  const [selectedPhase, setSelectedPhase] = useState(null); // State to track selected phase
  ...
  // Event handler for selecting customer phase
  const selectCustomer = () => {
    setSelectedPhase("customer");
  };

  // Event handler for selecting owner phase
  const selectOwner = () => {
    setSelectedPhase("owner");
  };
